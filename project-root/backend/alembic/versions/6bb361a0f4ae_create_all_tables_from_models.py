...
down_revision: Union[str, None] = '604c20d8dad2'
...
def upgrade() -> None:
    ...
    sa.Column('planned_ready', sa.DateTime(timezone=True), nullable=True),
    sa.Column('actual_ready', sa.DateTime(timezone=True), nullable=True),
    ...
    op.create_index('idx_documents_operation', 'documents', ['operation_id'], unique=False)
    op.create_index('ix_doc_author_created', 'documents', ['author_id', 'created_at'], unique=False)
    op.create_index('ix_doc_project_status', 'documents', ['project_id', 'status'], unique=False)
    op.create_index('ix_doc_project_type', 'documents', ['project_id', 'doc_type'], unique=False)
    op.create_index('ix_doc_section', 'documents', ['section_id'], unique=False)
    ...
    sa.Column('related_remark_ids', postgresql.ARRAY(sa.UUID()), server_default='{}', nullable=False),
...
def downgrade() -> None:
    ...
    op.drop_index('idx_documents_operation', table_name='documents')
