...
export default function Layout() {
  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ background: 'var(--layout-bg)', color: 'var(--text-primary)' }}>
      ...
      {/* ===== ШАПКА — ФИКСИРОВАНА, МАСШТАБИРУЕТСЯ, ВСЕГДА ПОВЕРХ ===== */}
      <div 
      ...
      >
        <header className="border-b" style={{ background: 'var(--header-bg)', borderColor: 'var(--header-border)' }}>
        ...
        {/* ===== ТАБЫ — ФИКСИРОВАНЫ, МАСШТАБИРУЮТСЯ ===== */}
      ...
      </div> {/* ← закрывающий масштаб шапки */}

      {/* ===== ОТСТУП ДЛЯ ШАПКИ ===== */}
      <div style={{ height: `${112 * scale}px` }} />
      ...
      >
        <main className="px-4 py-6 md:px-6" style={{ background: 'var(--layout-bg)', color: 'var(--text-primary)' }}>
