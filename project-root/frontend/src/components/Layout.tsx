...
export default function Layout() {
  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ background: 'var(--layout-bg)', color: 'var(--text-primary)' }}>
      ...
      {/* ===== ТАБЫ — С МАСШТАБИРОВАНИЕМ ===== */}
      <div className="fixed left-0 right-0 border-b z-40" style={{ 
        transform: `scale(${scale})`, 
        transformOrigin: 'top left',
        width: `${100 / scale}%`,
        top: `${56 * scale}px`,
      ...
      {/* ===== ОТСТУП ДЛЯ ШАПКИ И ТАБОВ (учитывает масштаб) ===== */}
      <div style={{ height: `${108 * scale}px` }} />
