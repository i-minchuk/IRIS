...
import { Eye, EyeOff, ArrowLeft, UserPlus, User, Mail, Lock } from 'lucide-react';
    ...
    <div className="min-h-screen flex flex-col relative overflow-hidden" style={{ background: isDark ? '#0D1117' : '#F5F6FA' }}>
      ...
      <div className="flex-1 flex items-center justify-center px-5 py-10">
        <div className="w-full max-w-[400px] p-10 rounded-2xl" style={{ background: cardBg, border: `1px solid ${cardBorder}` }}>
          ...
          <h2 className="text-xl font-bold text-center mb-1" style={{ color: textMain }}>Регистрация</h2>
          <p className="text-[13px] text-center mb-7" style={{ color: textMuted }}>Создайте аккаунт в ДокПоток IRIS</p>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <button type="submit" disabled={isLoading}
              ...
              {isLoading ? <span className="animate-spin">⟳</span> : <>Зарегистрироваться <UserPlus size={16} /></>}
            </button>
          </form>
