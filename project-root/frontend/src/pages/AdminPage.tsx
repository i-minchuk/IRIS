        ...
        <div className="space-y-4">
          <div>
            ...
            {fieldErrors.fullName && (
              <p className="text-base md:text-lg font-medium leading-relaxed mt-1 mt-1" style={{ color: 'var(--error)' }}>{fieldErrors.fullName}</p>
            )}
          </div>
          <div>
            <label className="block text-base md:text-lg font-medium leading-relaxed mt-1 font-medium mb-1" style={{ color: 'var(--text-secondary)' }}>Роль</label>
            <select
              value={role}
