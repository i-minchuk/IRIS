  ...
  return (
    <div className="grid grid-cols-4 gap-3 mt-3">
      <div className="bg-gray-50 rounded border border-gray-200 p-2">
        <div className="text-[10px] text-gray-400 uppercase font-semibold">Свойства</div>
      ...
      <div className="bg-gray-50 rounded border border-gray-200 p-2">
        <div className="text-[10px] text-gray-400 uppercase font-semibold">Замечания</div>
        <div className="text-xs text-gray-700 mt-1">
      ...
      <div className="bg-gray-50 rounded border border-gray-200 p-2">
        <div className="text-[10px] text-gray-400 uppercase font-semibold">Ревизии</div>
        <div className="text-xs text-gray-700 mt-1">
      ...
      <div className="bg-gray-50 rounded border border-gray-200 p-2">
        <div className="text-[10px] text-gray-400 uppercase font-semibold">Согласование</div>
        <div className="text-xs text-gray-700 mt-1">
